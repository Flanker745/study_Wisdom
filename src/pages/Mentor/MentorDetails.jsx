...
import { FaPhone, FaVideo, FaComment, FaCheckCircle, FaStar, FaCalendarCheck } from "react-icons/fa";
...
const MentorDetails = () => {
  ...
  const handleCallClick = () => {
    window.location.href = `tel:7014944745`;
  };

  const handleVideoCallClick = () => {
    // window.open(`https://wa.me/${mentor.phone}?video=true`, "_blank");
    window.open(`https://wa.me/${7014944745}?video=true`, "_blank");
  };
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 py-12 px-4">
      <div className="max-w-6xl mx-auto bg-white dark:bg-gray-950 shadow-lg rounded-xl p-8">
        ...
        <div className="flex flex-col items-center text-center space-y-4">
          <img
            src={mentor.profileImage || dp}
            alt={mentor.dppName}
            className="w-32 h-32 rounded-full border-4 border-purple-500 shadow-lg"
          />
          <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-100">{mentor.dppName}</h2>
          {mentor.verified && (
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300">{mentor.about}</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100">Expertise</h3>
          ...
          {/* Field */}
          <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100">Field</h3>
            <div className="flex items-center mt-2 text-gray-500 dark:text-gray-300">
          ...
          {/* Experience */}
          <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100">Experience</h3>
            <div className="flex items-center mt-2 text-gray-500 dark:text-gray-300">
              <FiBriefcase className="text-purple-600 text-2xl mr-2" />
          ...
          {/* Qualifications */}
          <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100">Qualifications</h3>
            <p className="mt-2 text-gray-500 dark:text-gray-300">{mentor.qualifications}</p>
          </div>

          {/* Rating */}
          <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100">Rating</h3>
          ...
          {/* Availability */}
          <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100">Availability</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
          ...
          >
            ...
            <p className="text-lg font-semibold mt-2">${mentor.price.videoCall}</p>
